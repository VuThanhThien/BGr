<template>
  <div class="main">
    ...
    <div
      ...
      class="mx-auto col-xl-6  pb-10 order-2 order-lg-1"
    >
      <!-- LOGO -->
    ...
    <div
      ...
      class="register-aside col-xl-6 px-10 order-1 order-lg-2"
      :style="{ 'background-image': 'url(' + baseObjToGen.aside.bgImg3 + ')',
