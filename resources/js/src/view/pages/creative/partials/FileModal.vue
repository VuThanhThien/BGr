    ...
    <div class="card card-custom card-stretch gutter-b">
      <b-tabs card nav-class="nav-tabs-line">
        ...
        <b-tab title="Bulk upload" lazy>
          <BulkUploadFileModal
            @saveFileSuccess="bulkUploadSuccess"
          ></BulkUploadFileModal>
        </b-tab>
      </b-tabs>
    </div>
...
import BulkUploadFileModal from "./BlukUploadFileModal.vue";
export default {
    ...
    updateImage() {
      ...
      if (this.image != null) {
        ...
        if (file.status) {
          ...
          ApiService.post("/categorys/create-creative", formData).then(
            ({ data }) => {
              this.image = null;
              this.$emit("saveFileSuccess");
