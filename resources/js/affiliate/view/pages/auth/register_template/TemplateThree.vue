<template>
  <div class="main page-loading ">
    ...
    <div
      ...
      class="mx-auto col-xxl-5 col-lg-6 sign-up-container pb-10 "
    >
      <!-- LOGO -->
    ...
    <!-- ASIDE -->
    <div
    v-if="baseObjToGen.name == 'template3Obj'"
      class="register-aside col-xxl-7 col-lg-6 px-10 "
      :style="{
        'background-image': 'url(' + baseObjToGen.aside.bgImg3 + ')',
        'background-color': baseObjToGen.aside.bgAside3,
    ...
    >
      <div
        id="overlay"
        :style="'background-color: rgba(0,0,0,0.' + baseObjToGen.aside.overlay3 || 0 + ')'"
      ></div>
